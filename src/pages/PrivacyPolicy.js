      ...
      <section className="section bg-bg-dark">
        <div className="container-custom max-w-3xl mx-auto">
          <div className="prose prose-invert">
            <p className="text-text-secondary mb-6">At Webintegratorz, we take your privacy seriously. This policy describes how we collect, use, and protect your personal information.</p>
            ...
            <p className="text-text-secondary">If you have questions about this Privacy Policy, please contact us at info@webintegratorz.com.</p>
          </div>
        </div>
      </section>
    </>
